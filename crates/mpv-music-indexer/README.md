...
Binaries for Linux (`x86_64-unknown-linux-musl`, `aarch64-unknown-linux-musl`, `armv7-unknown-linux-musleabihf`) can be downloaded from the [GitHub releases page](https://github.com/FurqanHun/mpv-music/releases). Those binaries are statically linked and should work on most Linux distributions.
